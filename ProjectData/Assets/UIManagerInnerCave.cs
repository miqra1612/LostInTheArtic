...
public class UIManagerInnerCave : MonoBehaviour
{
    ...
    public void CheckingAnswer1(bool canAdvance)
    {
        ...
        if (a > 0)
        {
            ...
            GameData.instance.innerCavePuzzleOpen[0] = true;
        }
        else
        {
    ...
    {
        bool isComplete = GameData.instance.innerCavePuzzleOpen[0];
    ...
    public void SwitchCorrect1(bool isActive)
    {
        if (isActive)
        {
            ...
            clue1On = true;
            sceneController.OpenScene("Inner Temple");
        }
        else
        {
            ClosePanel();
