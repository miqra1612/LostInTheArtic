...
public class UIManagerFacility : MonoBehaviour
{
    ...
    public GameObject cabinetBeforePanel;
    public GameObject cabinetAfterPanel;
    ...
    void Start()
    {
        ...
        clueBtn1.onClick.AddListener(() => OpenMap(clue1));
    ...
    public void SwitchCorrect1(bool isActive)
    {
        if (isActive)
        {
            cabinetBeforePanel.SetActive(false);
            cabinetAfterPanel.SetActive(true);
            //ClosePanel();
            OpenPanel(puzzleClue1);
            clue1On = true;
        }
        else
        {
