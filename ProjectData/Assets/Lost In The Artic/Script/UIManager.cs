...
public class UIManager : MonoBehaviour
{
    ...
    [Header("This area is for button puzzle clue")]
    ...
    public Button snowmobileKeyBtn;
    public Button keyBtn;
    public Button pickUpKeyBtn;
    public GameObject snowmobileKeyPanel;
    public GameObject snowDriftPanel;
    ...
    void Start()
    {
        ...
        pickUpKeyBtn.onClick.AddListener(() => ActivateSnowmobileBtn());
        snowmobileKeyBtn.onClick.AddListener(() => ActivatePuzzleSnowmobile());
    ...
    public void ClueWithPuzzle1(RectTransform panel)
    {
        ...
        if (isComplete)
        {
            sceneController.OpenScene("Inner Hut");
        }
    ...
    public void DoorClue(RectTransform panel)
    {
        bool isComplete = GameData.instance.room1PuzzleOpen[0];
    ...
    public void ActivateKey()
    {
        ...
        if (visionOpen)
        {
            snowDriftPanel.SetActive(true);
            snowmobileKeyPanel.SetActive(false);
        }
    }

    void ActivateSnowmobileBtn()
    {
        snowmobileKeyBtn.interactable = true;
    }
    
    void ActivatePuzzleSnowmobile()
    {
        notificationDisplay2.gameObject.SetActive(true);
        snowmobileKeyBtn.gameObject.SetActive(false);
    }
}
