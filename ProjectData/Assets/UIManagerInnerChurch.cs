...
public class UIManagerInnerChurch : MonoBehaviour
{
    ...
    public void CheckingAnswer1(bool canAdvance)
    {
        ...
        if (a > 0)
        {
            ...
            GameData.instance.innerChurchPuzzleOpen[0] = true;
        }
        else
        {
    ...
    {
        bool isComplete = GameData.instance.innerChurchPuzzleOpen[0];
